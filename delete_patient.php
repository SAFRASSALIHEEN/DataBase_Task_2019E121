...
$sql = "DELETE FROM patients WHERE hidden_id = $hiddenId";
...
// try {
// $id = $_GET['id'];
// $query = "DELETE `id`, `patient_name`, `address`, 
...
//           <h3 class="card-title">Delete Patients</h3>
...
//                 <button type="delete" id="delete_Patient" 
//                 name="delete_Patient" class="btn btn-primary btn-sm btn-flat btn-block">Delete</button>
//               </div>
//             </div>
//           </form>
//         </div>
