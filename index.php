...
<head>
  ...
  <title>Login - Hospital Management System by 2019/E/121</title>
...
<div class="login-box">
  <div class="login-logo mb-4">
    <img src="dist/img/logo.png" class="img-thumbnail p-0 border rounded-circle" id="system-logo">
    <div class="text-center h2 mb-0">Hospital Management System by Safras M.S.M - 2019/E/121</div>
  </div>
  <!-- /.login-logo -->
  <div class="card card-outline card-primary rounded-0 shadow">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Please enter your login details</p>
      <form method="post">
