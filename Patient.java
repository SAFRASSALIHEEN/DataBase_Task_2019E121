...
public class Patient extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            PreparedStatement ps = con.prepareStatement("insert into patients(Gender,Fname,Lname,Telnum,Age,Address)values(?,?,?,?,?,?)");
            
            
            if(jRadioButton1.isSelected())
            {
                ps.setString(1,jRadioButton1.getText());
            }
            else
                ps.setString(1,jRadioButton2.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/hms","root","");
            PreparedStatement ps = con.prepareStatement("UPDATE patients set Gender=?,Fname=?,Lname=?,Telnum=?,Age=?,Address=? where id=? ");
