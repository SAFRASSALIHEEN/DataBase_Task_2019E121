...
//now to store data in medication history
    ...
    $message = 'Patient visit details stored successfully.';
...
<head>
 ...
 <title>Visiting details of patients - HMS</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Visiting details of patients</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Add the details of visiting of a patient</h3>
